...
function PackageViewContent({ embedLayout = false, packageData = null }) {
			...
			>
				...
				<aside style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
					...
					>
						...
						<div style={{ marginTop: '6px', fontSize: '28px', fontWeight: 700, color: '#2563EB' }}>{packagePrice}</div>
...
export default function PackageView(props) {
	...
	return <PackageViewContent {...props} packageData={packageData} />
}
